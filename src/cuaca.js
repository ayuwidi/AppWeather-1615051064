...
export default class Cuaca extends React.Component {
  ...
  getWeather= () => {
    let url = 'http://api.openweathermap.org/data/2.5/weather?q=' + this.state.city + '&appid=13af4f6dc945bd9db95625de88104966&units=metric';
    fetch (url)
    ...
    .then((responseJson) => {
      ...
      });13af4f6dc945bd9db95625de88104966
    });
  }
  render() {
    return (
    <View style={styles.containerMain}>
      ...
      <View style={styles.box1}>
          <Text style={{ textAlign: 'center', color: 'white', padding: 12, fontSize: 17 }} > copyright @ayuwidi </Text>
      </View>
